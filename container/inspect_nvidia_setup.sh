#!/usr/bin/env bash
# =============================================================================
# DEPRECATED: Use diagnose_nvidia.sh instead
# =============================================================================
# This script is deprecated and will be removed in a future release.
# The functionality has been consolidated into diagnose_nvidia.sh which provides:
#   - diagnose_nvidia.sh        # Comprehensive diagnostic inspection (default)
#   - diagnose_nvidia.sh --fix  # Apply fixes
#   - diagnose_nvidia.sh --test # Run Docker GPU validation
# =============================================================================
echo "WARNING: inspect_nvidia_setup.sh is deprecated. Use 'diagnose_nvidia.sh' instead." >&2
