#!/usr/bin/env bash
# =============================================================================
# DEPRECATED: Use diagnose_nvidia.sh --fix instead
# =============================================================================
# This script is deprecated and will be removed in a future release.
# The functionality has been consolidated into diagnose_nvidia.sh which provides:
#   - diagnose_nvidia.sh        # Diagnostic inspection only
#   - diagnose_nvidia.sh --fix  # Apply fixes (equivalent to this script)
#   - diagnose_nvidia.sh --test # Run Docker GPU validation
# =============================================================================
echo "WARNING: fix_nvidia_setup.sh is deprecated. Use 'diagnose_nvidia.sh --fix' instead." >&2
