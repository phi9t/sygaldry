...
You are reviewing the 15 open RFC files in `docs/` against the current state of
...
For **each of the 15 open RFCs**, assign one label based on what the ground-truth
commands showed:
