...
You are reviewing the 17 open RFC files in `docs/` against the current state of
...
For **each of the 17 open RFCs**, assign one label based on what the ground-truth
commands showed:
